...
//         const toolbar = quill.getModule("toolbar");
//         if (toolbar?.container) {
//             toolbar.container.classList.add("bg-opacity-50", "rounded-lg", "px-4");
//         }

//         // Listen for text changes to update word/character count
...
//                     <button 
//                         className="mt-6 text-gray-300 hover:text-white transition-colors duration-200 w-full py-2 font-medium flex items-center justify-center"
//                         onClick={() => setShowModal(false)}
//                         disabled={isExporting}
//                     >
//                         <span>Cancel</span>
...
//                     </h1>
//                     <p className="text-gray-400 mt-1">Your Words, Synchronized.</p>
//                 </div>
                
//                 {/* Main Editor */}
//                 <div className="flex-grow relative rounded-lg overflow-hidden border border-slate-700">
//                     <div className="container"
//                         ref={useCallback((wrapper) => {
//                             if (!wrapper) return;
//                             wrapper.innerHTML = "";
//                             const editor = document.createElement("div");
//                             editor.className = "bg-slate-900 min-h-[500px] text-gray-200";
//                             wrapper.append(editor);
//                             const q = new Quill(editor, { 
//                                 theme: "snow", 
//                                 modules: MODULES,
...
//                             // Customize Quill Elements
//                             const toolbar = editor.previousSibling;
//                             if (toolbar) {
//                                 toolbar.classList.add("bg-slate-800", "border-none", "flex", "justify-center", "p-2");
...
//                                 exportBtn.className = "bg-blue-600 hover:bg-blue-700 rounded-full p-2 ml-4 text-white flex items-center justify-center";
//                                 exportBtn.title = "Export Document";
//                                 exportBtn.onclick = () => setShowModal(true);
//                                 toolbar.appendChild(exportBtn);
//                             }
                            
//                             const editorContainer = editor.querySelector(".ql-container");
//                             if (editorContainer) {
//                                 editorContainer.classList.add("border-none");
//                             }
                            
//                             const editorContent = editor.querySelector(".ql-editor");
//                             if (editorContent) {
//                                 editorContent.classList.add("min-h-[60vh]", "text-gray-200", "text-lg");
//                             }
...
//                     {/* Word Count */}
//                     <div className="absolute bottom-2 left-2 bg-slate-800 bg-opacity-70 px-3 py-1 rounded-md text-gray-400 text-sm flex items-center">
//                         <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" className="mr-1"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"></path><polyline points="14 2 14 8 20 8"></polyline></svg>
